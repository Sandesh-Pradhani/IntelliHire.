    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="space-y-6">
        {loading ? (
          ...
          resumes.map((resume) => (
            <div key={resume._id} className="bg-white rounded-3xl shadow-lg p-8 border border-slate-100 hover:shadow-md transition-shadow duration-300">
              <div className="flex justify-between items-center">
                <div>
                  <h2 className="text-2xl font-bold text-slate-800">{resume.filename}</h2>
                  <p className="text-slate-500 mt-2">Uploaded Resume Analysis</p>
                </div>
                <div className="text-right">
                  <h2 className="text-4xl font-bold text-blue-600">{resume.atsScore}</h2>
