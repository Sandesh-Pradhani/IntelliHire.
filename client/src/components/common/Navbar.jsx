...
import { Bell, LogIn, LogOut, Moon, Search, Sparkles, UserPlus, X } from 'lucide-react'
      ...
      <div className="flex h-full items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          {user ? (
            <>
              <Link
                to={user.role === 'recruiter' ? ROUTES.RECRUITER.SEARCH : ROUTES.CANDIDATE.SEARCH}
                className="rounded-xl p-2.5 text-slate-400 transition-all duration-200 hover:bg-slate-100 hover:text-slate-600"
                title="Global Search"
              >
