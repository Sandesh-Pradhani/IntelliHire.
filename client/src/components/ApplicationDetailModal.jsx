        ...
        >
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-fade-in">
                ...
                <div className="p-6 space-y-6">
                    ...
                    {/* Application Date & Intelligence Link */}
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-4 border-t border-slate-100">
                        ...
                        <a
                            ...
                            className="inline-flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-4 py-2 text-xs font-bold text-white shadow-sm hover:bg-blue-500 transition-colors"
                        >
                            <TrendingUp className="h-3.5 w-3.5" /> View Full Intelligence Profile
                        </a>
                    </div>
                </div>
            </div>
